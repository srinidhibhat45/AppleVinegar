...
export function buildCommands(): Command[] {
  ...
  const cmds: Command[] = [
    ...
    { id: 'guides', title: 'Show / hide all layout grids', group: 'View', icon: 'columns', keys: `${mod} ;`, run: () => S().setPrefs({ showGuides: !S().prefs.showGuides }) },
    { id: 'grid-toggle', title: 'Layout grid on this frame', group: 'View', icon: 'grid', keys: '⇧G', run: () => S().toggleGrid() },
